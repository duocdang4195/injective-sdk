...
export const WORMHOLE_NATIVE_WRAPPED_ADDRESS = (network) => {
    if (isTestnet(network) || isDevnet(network)) {
        return {
        //
        };
