...
export interface UiSubaccountBalanceWithToken extends Omit<UiSubaccountBalance, 'totalBalance' | 'denom' | 'availableBalance'> {
    totalBalance: string;
    availableBalance: string;
}
...
export interface UiSubaccountTransfer extends Omit<SubaccountTransfer, 'amount'> {
    amount: string;
    denom: string;
}
