import { BridgeTransactionState, BridgingNetwork, } from './../types/bridge';
import { isTestnet, isMainnet, Network, isDevnet, } from '@injectivelabs/networks';
import { MintScanExplorerUrl } from './../types/bridge';
import { PEGGY_GRAPH_URL, PEGGY_DEVNET_GRAPH_URL, PEGGY_DEVNET1_GRAPH_URL, PEGGY_DEVNET2_GRAPH_URL, PEGGY_TESTNET_GRAPH_URL, } from '../constants';
...
export const cosmosNativeDenomsFromChainId = {
    ...
    [CosmosChainId.Juno]: {
        ...
        tokenType: TokenType.Ibc,
        denom: 'ibc/D50E26996253EBAA8C684B9CD653FE2F7665D7BDDCA3D48D5E1378CF6334F211',
    },
    ...
    [TestnetCosmosChainId.Cosmoshub]: {
        ...
        tokenType: TokenType.Ibc,
        denom: 'ibc/48BC9C6ACBDFC1EBA034F1859245D53EA4BF74147189D66F27C23BF966335DFB',
    },
...
export const ibcHashToNativeInjPerNetwork = {
    [BridgingNetwork.Osmosis]: 'ibc/64BA6E31FE887D66C6F8F31C7B1A80C7CA179239677B4088BB55F5EA07DBE273',
    [BridgingNetwork.Crescent]: 'ibc/5A76568E079A31FA12165E4559BA9F1E9D4C97F9C2060B538C84DCD503815E30',
    [BridgingNetwork.Persistence]: 'ibc/D64E84758BCA42602C27E9ED2DB8F4EFDAE6A1E311CF404B516D45FEDF319D73',
    [BridgingNetwork.Stride]: 'ibc/A7454562FF29FE068F42F9DE4805ABEF54F599D1720B345D6518D9B5C64EA6D2',
};
export const ibcHashToNativeInjPerCosmosChain = {
    [CosmosChainId.Osmosis]: 'ibc/64BA6E31FE887D66C6F8F31C7B1A80C7CA179239677B4088BB55F5EA07DBE273',
    [CosmosChainId.Crescent]: 'ibc/5A76568E079A31FA12165E4559BA9F1E9D4C97F9C2060B538C84DCD503815E30',
    [CosmosChainId.Persistence]: 'ibc/D64E84758BCA42602C27E9ED2DB8F4EFDAE6A1E311CF404B516D45FEDF319D73',
    [CosmosChainId.Stride]: 'ibc/A7454562FF29FE068F42F9DE4805ABEF54F599D1720B345D6518D9B5C64EA6D2',
};
...
export const getCosmosExplorerUrl = (bridgingNetwork = BridgingNetwork.CosmosHub, network) => {
...
export const getEthereumExplorerUrl = (network) => {
    if (isDevnet(network)) {
...
export const getArbitrumExplorerUrl = (network) => {
    if (isDevnet(network)) {
...
export const getPolygonExplorerUrl = (network) => {
    if (isDevnet(network)) {
...
export const getSolanaExplorerUrl = (network) => {
    if (isDevnet(network)) {
...
export const getTerraExplorerUrl = (network) => {
    if (isDevnet(network)) {
...
export const getPeggoGraphQlEndpoint = (network) => {
...
export const getNetworkFromAddress = (sender) => {
...
export const getBridgeTransactionType = (srcNetwork, dstNetwork) => {
    return `${srcNetwork}-${dstNetwork}`;
};
export const getGasPriceForCosmosNetwork = (network) => {
    switch (network) {
...
export const getGasPriceForChainId = (chainId) => {
    switch (chainId) {
...
export const formatWeb3Token = ({ transaction, tokenFromWeb3, }) => {
