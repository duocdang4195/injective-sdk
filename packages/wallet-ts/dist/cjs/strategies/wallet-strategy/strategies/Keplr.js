...
class Keplr extends Base_1.default {
    constructor(args) {
        super(args);
        this.chainId = args.chainId || ts_types_1.CosmosChainId.Injective;
        this.keplrWallet = new keplr_1.KeplrWallet(args.chainId, args.endpoints);
    }
    getWalletDeviceType() {
    ...
    sendTransaction(transaction, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield keplrWallet.waitTxBroadcasted(yield keplrWallet.broadcastTx(txRaw), (_a = options.endpoints) === null || _a === void 0 ? void 0 : _a.rest);
            }
            catch (e) {
