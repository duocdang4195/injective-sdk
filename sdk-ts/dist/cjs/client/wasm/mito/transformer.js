    ...
    static allocatorConfigResponseToAllocatorConfig(response) {
        ...
        return {
            ...
            maxActiveGaugesPerLpToken: data.max_active_gauges_per_lp_token
                ...
                : undefined,
            gaugeAllocationFeeDenom: formatToString((_a = data.gauge_allocation_fee) === null || _a === void 0 ? void 0 : _a.denom),
            gaugeAllocationFeeAmount: formatToString((_b = data.gauge_allocation_fee) === null || _b === void 0 ? void 0 : _b.amount),
        };
    }
