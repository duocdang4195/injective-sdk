 ...
 */
class IndexerGrpcMitoApi extends BaseGrpcConsumer_1.default {
    ...
    fetchVaultsByHolderAddress({ limit, pageIndex, holderAddress, vaultAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchLPHolders({ limit, pageIndex, vaultAddress, stakingContractAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchIDOSubscribers({ contractAddress, limit, skip, }) {
        return __awaiter(this, void 0, void 0, function* () {
