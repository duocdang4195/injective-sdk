export class DmmGrpcTransformer {
    ...
    static liquiditySnapshotsResponseToLiquiditySnapshots(response) {
        const snapshots = response.snapshots;
        return {
            next: response.next,
            snapshots: snapshots.map(DmmGrpcTransformer.grpcLiquiditySnapshotsToLiquiditySnapshots),
        };
    }
    static grpcLiquiditySnapshotsToLiquiditySnapshots(snapshot) {
        return {
