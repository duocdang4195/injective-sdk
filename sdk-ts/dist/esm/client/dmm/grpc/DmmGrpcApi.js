...
export class DmmGrpcApi extends BaseGrpcConsumer {
    ...
    async fetchLiquiditySnapshots({ epochId, marketId, accountAddress, page, }) {
        ...
        try {
            const response = await this.retry(() => this.client.GetLiquiditySnapshots(request));
            return DmmGrpcTransformer.liquiditySnapshotsResponseToLiquiditySnapshots(response);
        }
        catch (e) {
            if (e instanceof InjectiveDmmRpc.GrpcWebError) {
                throw new GrpcUnaryRequestException(new Error(e.toString()), {
