...
export interface GetLiquiditySnapshotsRequest {
    epochId: string;
    marketId: string;
...
export interface GetLiquiditySnapshotsResponse {
...
export declare const GetLiquiditySnapshotsRequest: {
    encode(message: GetLiquiditySnapshotsRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): GetLiquiditySnapshotsRequest;
    fromJSON(object: any): GetLiquiditySnapshotsRequest;
    toJSON(message: GetLiquiditySnapshotsRequest): unknown;
    create(base?: DeepPartial<GetLiquiditySnapshotsRequest>): GetLiquiditySnapshotsRequest;
    fromPartial(object: DeepPartial<GetLiquiditySnapshotsRequest>): GetLiquiditySnapshotsRequest;
};
export declare const GetLiquiditySnapshotsResponse: {
    encode(message: GetLiquiditySnapshotsResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): GetLiquiditySnapshotsResponse;
    fromJSON(object: any): GetLiquiditySnapshotsResponse;
    toJSON(message: GetLiquiditySnapshotsResponse): unknown;
    create(base?: DeepPartial<GetLiquiditySnapshotsResponse>): GetLiquiditySnapshotsResponse;
    fromPartial(object: DeepPartial<GetLiquiditySnapshotsResponse>): GetLiquiditySnapshotsResponse;
};
...
export declare const LiquidityScoreSnapshot: {
    encode(message: LiquidityScoreSnapshot, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): LiquidityScoreSnapshot;
    fromJSON(object: any): LiquidityScoreSnapshot;
    toJSON(message: LiquidityScoreSnapshot): unknown;
    create(base?: DeepPartial<LiquidityScoreSnapshot>): LiquidityScoreSnapshot;
    fromPartial(object: DeepPartial<LiquidityScoreSnapshot>): LiquidityScoreSnapshot;
};
...
export interface InjectiveDmmV2RPC {
    ...
    GetLiquiditySnapshots(request: DeepPartial<GetLiquiditySnapshotsRequest>, metadata?: grpc.Metadata): Promise<GetLiquiditySnapshotsResponse>;
...
export declare const InjectiveDmmV2RPCGetLiquiditySnapshotsDesc: UnaryMethodDefinitionish;
