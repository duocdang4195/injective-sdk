...
export const GetEpochsRequest = {
    ...
    create(base) {
        return GetEpochsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEpochsRequest();
...
export const GetEpochsResponse = {
    ...
    fromJSON(object) {
        return { epochs: Array.isArray(object === null || object === void 0 ? void 0 : object.epochs) ? object.epochs.map((e) => EpochV2.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.epochs) {
    ...
    create(base) {
        return GetEpochsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEpochsResponse();
        message.epochs = ((_a = object.epochs) === null || _a === void 0 ? void 0 : _a.map((e) => EpochV2.fromPartial(e))) || [];
        return message;
    },
};
...
export const GetLiquiditySnapshotsRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.epochId !== "") {
    ...
    create(base) {
        return GetLiquiditySnapshotsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetLiquiditySnapshotsRequest();
...
export const GetLiquiditySnapshotsResponse = {
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.snapshots) {
            LiquidityScoreSnapshot.encode(v, writer.uint32(10).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.snapshots.push(LiquidityScoreSnapshot.decode(reader, reader.uint32()));
                    continue;
                case 2:
                    if (tag != 18) {
                        break;
    ...
    fromJSON(object) {
        return {
            snapshots: Array.isArray(object === null || object === void 0 ? void 0 : object.snapshots)
                ? object.snapshots.map((e) => LiquidityScoreSnapshot.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.snapshots) {
            obj.snapshots = message.snapshots.map((e) => e ? LiquidityScoreSnapshot.toJSON(e) : undefined);
        }
        else {
            obj.snapshots = [];
        }
    ...
    create(base) {
        return GetLiquiditySnapshotsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetLiquiditySnapshotsResponse();
        message.snapshots = ((_a = object.snapshots) === null || _a === void 0 ? void 0 : _a.map((e) => LiquidityScoreSnapshot.fromPartial(e))) || [];
...
export const GetTotalScoresRequest = {
    ...
    create(base) {
        return GetTotalScoresRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetTotalScoresRequest();
...
export const GetTotalScoresResponse = {
    ...
    fromJSON(object) {
        return {
            scores: Array.isArray(object === null || object === void 0 ? void 0 : object.scores) ? object.scores.map((e) => TotalScore.fromJSON(e)) : [],
            next: isSet(object.next) ? Pagination.fromJSON(object.next) : undefined,
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return GetTotalScoresResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTotalScoresResponse();
        message.scores = ((_a = object.scores) === null || _a === void 0 ? void 0 : _a.map((e) => TotalScore.fromPartial(e))) || [];
        message.next = (object.next !== undefined && object.next !== null)
            ? Pagination.fromPartial(object.next)
            : undefined;
        return message;
...
export const GetTotalScoresHistoryRequest = {
    ...
    create(base) {
        return GetTotalScoresHistoryRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetTotalScoresHistoryRequest();
...
export const GetTotalScoresHistoryResponse = {
    ...
    create(base) {
        return GetTotalScoresHistoryResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTotalScoresHistoryResponse();
...
export const GetEpochScoresRequest = {
    ...
    create(base) {
        return GetEpochScoresRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEpochScoresRequest();
...
export const GetEpochScoresResponse = {
    ...
    fromJSON(object) {
        return {
            scores: Array.isArray(object === null || object === void 0 ? void 0 : object.scores) ? object.scores.map((e) => EpochScore.fromJSON(e)) : [],
            next: isSet(object.next) ? Pagination.fromJSON(object.next) : undefined,
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return GetEpochScoresResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEpochScoresResponse();
        message.scores = ((_a = object.scores) === null || _a === void 0 ? void 0 : _a.map((e) => EpochScore.fromPartial(e))) || [];
        message.next = (object.next !== undefined && object.next !== null)
            ? Pagination.fromPartial(object.next)
            : undefined;
        return message;
...
export const GetEpochScoresHistoryRequest = {
    ...
    create(base) {
        return GetEpochScoresHistoryRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetEpochScoresHistoryRequest();
...
export const GetEpochScoresHistoryResponse = {
    ...
    create(base) {
        return GetEpochScoresHistoryResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEpochScoresHistoryResponse();
...
export const GetMarketRewardsRequest = {
    ...
    create(base) {
        return GetMarketRewardsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetMarketRewardsRequest();
...
export const GetMarketRewardsResponse = {
    ...
    fromJSON(object) {
        return { rewards: Array.isArray(object === null || object === void 0 ? void 0 : object.rewards) ? object.rewards.map((e) => MarketReward.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.rewards) {
    ...
    create(base) {
        return GetMarketRewardsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetMarketRewardsResponse();
        message.rewards = ((_a = object.rewards) === null || _a === void 0 ? void 0 : _a.map((e) => MarketReward.fromPartial(e))) || [];
        return message;
    },
};
...
export const GetEligibleAddressesRequest = {
    ...
    create(base) {
        return GetEligibleAddressesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEligibleAddressesRequest();
...
export const GetEligibleAddressesResponse = {
    ...
    fromJSON(object) {
        return {
            addresses: Array.isArray(object === null || object === void 0 ? void 0 : object.addresses) ? object.addresses.map((e) => EligibleAddress.fromJSON(e)) : [],
            next: isSet(object.next) ? Pagination.fromJSON(object.next) : undefined,
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return GetEligibleAddressesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetEligibleAddressesResponse();
        message.addresses = ((_a = object.addresses) === null || _a === void 0 ? void 0 : _a.map((e) => EligibleAddress.fromPartial(e))) || [];
        message.next = (object.next !== undefined && object.next !== null)
            ? Pagination.fromPartial(object.next)
            : undefined;
        return message;
...
export const GetRewardsDistributionRequest = {
    ...
    create(base) {
        return GetRewardsDistributionRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetRewardsDistributionRequest();
...
export const GetRewardsDistributionResponse = {
    ...
    fromJSON(object) {
        return {
            rewards: Array.isArray(object === null || object === void 0 ? void 0 : object.rewards) ? object.rewards.map((e) => RewardDistribution.fromJSON(e)) : [],
            next: isSet(object.next) ? Pagination.fromJSON(object.next) : undefined,
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return GetRewardsDistributionResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetRewardsDistributionResponse();
        message.rewards = ((_a = object.rewards) === null || _a === void 0 ? void 0 : _a.map((e) => RewardDistribution.fromPartial(e))) || [];
        message.next = (object.next !== undefined && object.next !== null)
            ? Pagination.fromPartial(object.next)
            : undefined;
        return message;
...
export const GetAccountVolumesRequest = {
    ...
    create(base) {
        return GetAccountVolumesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetAccountVolumesRequest();
...
export const GetAccountVolumesResponse = {
    ...
    fromJSON(object) {
        return { volumes: Array.isArray(object === null || object === void 0 ? void 0 : object.volumes) ? object.volumes.map((e) => AccountVolume.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.volumes) {
    ...
    create(base) {
        return GetAccountVolumesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetAccountVolumesResponse();
        message.volumes = ((_a = object.volumes) === null || _a === void 0 ? void 0 : _a.map((e) => AccountVolume.fromPartial(e))) || [];
        return message;
    },
};
...
export const GetRewardsEligibilityRequest = {
    ...
    create(base) {
        return GetRewardsEligibilityRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetRewardsEligibilityRequest();
...
export const GetRewardsEligibilityResponse = {
    ...
    fromJSON(object) {
        return {
            volumes: Array.isArray(object === null || object === void 0 ? void 0 : object.volumes) ? object.volumes.map((e) => AccountVolume.fromJSON(e)) : [],
    ...
    create(base) {
        return GetRewardsEligibilityResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const EpochV2 = {
    ...
    create(base) {
        return EpochV2.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const Market = {
    ...
    create(base) {
        return Market.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseMarket();
...
export const EpochConfigV2 = {
    ...
    fromJSON(object) {
        return {
            ...
            markets: Array.isArray(object === null || object === void 0 ? void 0 : object.markets) ? object.markets.map((e) => Market.fromJSON(e)) : [],
    ...
    create(base) {
        return EpochConfigV2.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.markets = ((_e = object.markets) === null || _e === void 0 ? void 0 : _e.map((e) => Market.fromPartial(e))) || [];
...
export const LiquidityScoreSnapshot = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.epochId !== "") {
            writer.uint32(10).string(message.epochId);
        }
    ...
    create(base) {
        return LiquidityScoreSnapshot.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const TotalScore = {
    ...
    create(base) {
        return TotalScore.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const EpochScore = {
    ...
    create(base) {
        return EpochScore.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const MarketReward = {
    ...
    create(base) {
        return MarketReward.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const EligibleAddress = {
    ...
    create(base) {
        return EligibleAddress.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const RewardDistribution = {
    ...
    create(base) {
        return RewardDistribution.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export class InjectiveDmmV2RPCClientImpl {
    ...
    GetLiquiditySnapshots(request, metadata) {
        return this.rpc.unary(InjectiveDmmV2RPCGetLiquiditySnapshotsDesc, GetLiquiditySnapshotsRequest.fromPartial(request), metadata);
    }
...
export const InjectiveDmmV2RPCGetLiquiditySnapshotsDesc = {
    ...
    requestType: {
        serializeBinary() {
            return GetLiquiditySnapshotsRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = GetLiquiditySnapshotsResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
