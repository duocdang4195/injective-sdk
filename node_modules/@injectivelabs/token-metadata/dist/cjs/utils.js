...
exports.isCw20ContractAddress = exports.getUnknownTokenWithSymbol = exports.getUnknownToken = exports.getTokenFromMeta = exports.getCw20TokenSingle = exports.getTokenAddress = exports.getTokenDecimals = exports.getTokenSymbol = exports.getTokenTypeFromDenom = exports.getIbcTokenMetaFromDenomTrace = void 0;
...
const getTokenTypeFromDenom = (denom) => {
    ...
    if ((0, exports.isCw20ContractAddress)(denom)) {
...
const getTokenDecimals = (token) => {
    ...
    if ((0, exports.isCw20ContractAddress)(token.denom)) {
