...
var StargateClient = /** @class */ (function (_super) {
    __extends(StargateClient, _super);
    function StargateClient() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StargateClient.prototype.getAccount = function (searchAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var chainId, isInjective, account, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        chainId = _a.sent();
                        isInjective = chainId.startsWith('injective');
                    ...
                    case 2:
                        ...
                        if (isInjective) {
                            return [2 /*return*/, (0, accountParser_1.accountParser)(account)];
                        }
                        return [2 /*return*/, (0, stargate_1.accountFromAny)(account)];
                    case 3:
                        error_1 = _a.sent();
